...
const ManageJobs = () => {
  ...
  const onEditSubmit = (submitData) => {
    ...
    http.post('/admin-update-user',submitData)
    .then(res=>{
      ...
      <Content>
        <BlockHead size="sm">
          <BlockBetween>
            ...
            {!apiLoader &&   <BlockDes className="text-soft">
                <p>ISB ATS App has total {data?.length} Jobs.</p>
              </BlockDes>}
            </BlockHeadContent>
