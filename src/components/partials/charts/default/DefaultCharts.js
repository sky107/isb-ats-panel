...
import { Chart, CategoryScale, LinearScale, ArcElement, Tooltip, Filler, Legend, } from "chart.js";
Chart.register(CategoryScale, LinearScale, ArcElement, Tooltip, Filler, Legend, );
...
export const DefaultOrderStatistics = (props) => {
  const {data}=props;
  return (
    <Doughnut
      data={data}
