...
import TrackStatus from "../pages/RatifiTrackStatus/TrackStatus";
import RatifiUserListRegularPage from "../pages/RatifiUsers/user-manage/UserListRegular";
import RatifiTrackIFRStatus from "../pages/RatifiTrackIFRStatus/RatifiTrackIFRStatus";
import TrackIFRStatus from "../pages/RatifiTrackStatus/TrackIFRStatus";
import IFRStatus from "../pages/RatifiTrackStatus/IFRStatus";
import TabsPageIFR from "../pages/components/TabsIFR";
import RatifiTrackPotential from "../pages/RatifiTrackPotential/RatifiTrackPotential";
import GetRor from "../pages/Get ROR/GetRor";
import ManageJobs from "../pages/RatifiUsers2/user-manage/UserListRegular";
import TrackList from "../pages/TrackList/user-manage/UserListRegular";
...
const Pages = () => {
  ...
  useEffect(()=>{
    const rfctoken=localStorage.getItem('rfc-token');
    if(rfctoken){
      setISU(true)
    }
  },[])
  ...
  return (
    <Routes>
          <Route path="getROR" element={<GetRor/>}></Route>
        <Route path={`${process.env.PUBLIC_URL}`} element={<Layout />}>
         <Route index element={<Homepage />}></Route>
           <Route path="_blank" element={<Blank />}></Route>
          <Route path="track-cfr-and-cr-status" element={<TrackStatus />}></Route>
          <Route path="track-ifr" element={<IFRStatus/>}></Route>
          <Route path="track-users" element={<RatifiUserListRegularPage />}></Route>
          <Route path="track-jobs" element={<ManageJobs />}></Route>
          <Route path="track-list" element={<TrackList />}></Route>
          <Route path="track-ifr-claims" element={<RatifiTrackIFRStatus />}></Route>
          <Route path="track-potential" element={<RatifiTrackPotential />}></Route>
          ...
          <Route path="components">
            ...
            <Route path="tabsIFR" element={<TabsPageIFR />}></Route>
